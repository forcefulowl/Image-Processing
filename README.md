...
- Caculating the new thrsholding T' = 1/2(a1+a2).<br>a1 equals to the average of the value of pixel which is larger than T, <br>a2 equals to the average of the value of pixel which is smaller than T, and caculating the absolute value of (T-T'). 
